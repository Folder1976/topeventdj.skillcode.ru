...
class ControllerUserUser extends Controller {
	...
	protected function getList() {
		...
		if($user['user_group_id'] == 11){
			...
			$this->request->get['user_id'] = $this->session->data['user_id'];
			
			//die($this->url->link('user/user/edit', 'token=' . $this->session->data['token'].'&user_id=' . $this->session->data['user_id']));
			$this->response->redirect($this->url->link('user/user/edit', 'token=' . $this->session->data['token'].'&user_id=' . $this->session->data['user_id']));
	...
	protected function getForm() {
		...
		if($user['user_group_id'] == 11){
			...
			if($this->request->get['user_id'] != $this->session->data['user_id']){
				$this->request->get['user_id'] = $this->session->data['user_id'];
				$this->response->redirect($this->url->link('user/user/edit', 'token=' . $this->session->data['token'].'&user_id=' . $this->session->data['user_id']));
			}
		}
