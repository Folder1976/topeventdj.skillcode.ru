      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-calendar" data-toggle="tab">Календарь занятости</a></li>
            <li><a style="display:none;" href="#tab-option" data-toggle="tab"><?php echo $tab_option; ?></a></li>
            <li><a style="display:none;" href="#tab-recurring" data-toggle="tab"><?php echo $tab_recurring; ?></a></li>
            <li><a style="display:none;" href="#tab-discount" data-toggle="tab"><?php echo $tab_discount; ?></a></li>
            <li><a style="display:none;" href="#tab-special" data-toggle="tab"><?php echo $tab_special; ?></a></li>
            <li><a href="#tab-image" data-toggle="tab"><?php echo $tab_image; ?></a></li>
            <li><a style="display:none;" href="#tab-reward" data-toggle="tab"><?php echo $tab_reward; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-instagram_id"><span data-toggle="tooltip" title="user id">Инстаграм userid</span></label>
                <div class="col-sm-10">
                  <input type="text" name="instagram_id" value="<?php echo $instagram_id; ?>" placeholder="user id" id="input-instagram_id" class="form-control" />
                </div>
              </div>
             <div class="form-group">
                <label class="col-sm-2 control-label" for="input-instagram_code"><span data-toggle="tooltip" title="Инстаграм API code">Инстаграм API code</span></label>
                <div class="col-sm-10">
                  <input type="text" name="instagram_code" value="<?php echo $instagram_code; ?>" placeholder="Инстаграм API code" id="input-instagram_code" class="form-control" />
                </div>
              </div>
                ...
                <table id="calendar" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      ...
                      <td class="text-left">Занятость</td>
                      <td class="text-left">Описание для сайта</td>
                      <td class="text-left">Памятка для себя</td>
                      <td></td>
                    </tr>
                  </thead>
                  ...
                  <tbody>
                    ...
                    <tr id="calendar-row<?php echo $attribute_row; ?>">
                      <td class="text-left" style="width: 120px;">
                        <input type="date" name="calendar[<?php echo $calendar_row; ?>][date]" value="<?php echo $calendar['date']; ?>" placeholder="<?php echo date('Y-m-d'); ?>" class="form-control" data-date-format="YYYY-MM-DD" />
                        <input type="hidden" name="calendar[<?php echo $calendar_row; ?>][calendar_id]" value="<?php echo $calendar['calendar_id']; ?>" />
                      </td>
                    
                      <td class="text-left">
                        <input type="radio" name="calendar[<?php echo $calendar_row; ?>][busy]" value="1" <?php if((int)$calendar['busy'] == 1){?>checked="checked"<?php } ?>/> Занят <br>
                        <input type="radio" name="calendar[<?php echo $calendar_row; ?>][busy]" value="2" <?php if((int)$calendar['busy'] == 2){?>checked="checked"<?php } ?>/> Бронь <br>
                        <input type="radio" name="calendar[<?php echo $calendar_row; ?>][busy]" value="3" <?php if((int)$calendar['busy'] == 3){?>checked="checked"<?php } ?> /> Свободен
                      </td>
                      
                   
                      <td class="text-left">
                        <input type="text" name="calendar[<?php echo $calendar_row; ?>][text]" value="<?php echo $calendar['text']; ?>" placeholder="Короткое описание на сайт" class="form-control" />
                      </td>
                      <td class="text-left">
                        <div class="input-group"><span class="input-group-addon"></span>
                          <textarea name="calendar[<?php echo $calendar_row; ?>][description]" rows="3" placeholder="Памятка для себя" class="form-control"><?php echo isset($calendar['description']) ? $calendar['description'] : ''; ?></textarea>
                        </div>
                      </td>
                      <td class="text-left"><button type="button" onclick="$('#calendar-row<?php echo $attribute_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                    </tr>
                    <?php $calendar_row++; ?>
                    <?php } ?>
                  </tbody>
                  <tfoot>
                    <tr>
                      <td colspan="4"></td>
                      <td class="text-left"><button type="button" onclick="addCalendar();" data-toggle="tooltip" title="Добавить событие" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                    </tr>
                  </tfoot>
                </table>
              </div>
                ...
                <table id="images" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      ...
                      <td class="text-center">Десктоп</td>
                      <td class="text-center">Мобильный</td>
                  ...
                  <tbody>
                    ...
                    <tr id="image-row<?php echo $image_row; ?>">
                      ...
                      <td class="text-center">
                          <?php if ($product_image['desc']) { ?>
                          <input type="checkbox" name="product_image[<?php echo $image_row; ?>][desc]" value="1" checked="checked" />
                          <?php } else { ?>
                          <input type="checkbox" name="product_image[<?php echo $image_row; ?>][desc]" value="1" />
                          <?php } ?>
                      </td>
                      
                      <td class="text-center">
                          <?php if ($product_image['mobil']) { ?>
                          <input type="checkbox" name="product_image[<?php echo $image_row; ?>][mobil]" value="1" checked="checked" />
                          <?php } else { ?>
                          <input type="checkbox" name="product_image[<?php echo $image_row; ?>][mobil]" value="1" />
                          <?php } ?>
                      </td>
...
function addCalendar() {
	...
	html += '  <td class="text-left" style="width: 120px;"><input type="date" name="calendar[' + calendar_row + '][date]" value="" placeholder="<?php echo date('Y-m-d'); ?>" class="form-control" data-date-format="YYYY-MM-DD" /><input type="hidden" name="calendar[' + calendar_row + '][calendar_id]" value="" /></td>';
	html += '  <td class="text-left"><input type="radio" name="calendar[' + calendar_row + '][busy]" value="1" checked="checked"/> Занят <br>';
	html += '  <input type="radio" name="calendar[' + calendar_row + '][busy]" value="2" /> Бронь <br>';
	html += '  <input type="radio" name="calendar[' + calendar_row + '][busy]" value="3" /> Свободен </td>';
	html += '  <td class="text-left"><input type="text" name="calendar[' + calendar_row + '][text]" value="" placeholder="Короткое описание на сайт" class="form-control"/></td>';
	
  html += '<td class="text-left"><div class="input-group"><span class="input-group-addon"></span><textarea name="calendar[' + calendar_row + '][description]" rows="3" placeholder="Памятка для себя" class="form-control"></textarea></div>';
  html += '  </td>';
	html += '  <td class="text-left"><button type="button" onclick="$(\'#calendar-row' + calendar_row + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
    html += '</tr>';
...
function addImage() {
	...
	html += '  <td class="text-center"><input type="checkbox" name="product_image[' + image_row + '][desc]" value="1" /></td>';
	html += '  <td class="text-center"><input type="checkbox" name="product_image[' + image_row + '][mobil]" value="1" /></td>';
