...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['calendars_user'] = array();
		if(isset($this->request->get['product_id']) AND $this->request->get['product_id'] > 0){
			$data['calendars_user']  = $this->model_catalog_product->getProductCalendars($this->request->get['product_id']);
		}
		$data['calendars']  = $this->model_catalog_product->getProductCalendars();
	
	//echo "<pre>";print_r(var_dump($data['calendars'] ));echo "</pre>";
	//die();
