...
function addImage(language_id) {
	...
	html += '  <td class="text-left" style="width: 30%;"><input type="text" name="banner_image[' + language_id + '][' + image_row + '][link]" value="" placeholder="<?php echo $entry_link; ?>" class="form-control" /></td>';	
				...
				html = html + '<input type="text" name="banner_image[' + language_id + '][' + image_row + '][url]" value="" placeholder="/home/url;/home;" class="form-control" />';	
				html = html + '<input type="text" name="banner_image[' + language_id + '][' + image_row + '][text1]" value="" placeholder="текст для баннера 1" class="form-control" />';	
				html = html + '<input type="text" name="banner_image[' + language_id + '][' + image_row + '][text2]" value="" placeholder="текст для баннера 2" class="form-control" />';	
				html = html + '<input type="text" name="banner_image[' + language_id + '][' + image_row + '][text3]" value="" placeholder="текст для баннера 3" class="form-control" />';	
				html = html + '</td>';	
				<!-- Category banners * * * End -->
