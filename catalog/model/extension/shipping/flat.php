...
class ModelExtensionShippingFlat extends Model {
	function getQuote($address) {
		...
		$shiping_cost = $this->config->get('flat_cost');
		...
		if ($status) {
			...
			$quote_data['flat'] = array(
				...
				'text'         => $this->currency->format($this->tax->calculate($shiping_cost, $this->config->get('flat_tax_class_id'), $this->config->get('config_tax')), $this->session->data['currency'])
			);
