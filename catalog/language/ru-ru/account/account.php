...
$_['text_xls']                  = 'Загрузить XLS';
$_['text_upload']               = 'Загрузить';
$_['text_download_sample']      = 'Скачать образец';
$_['text_select_file']          = 'Выберите файл';
$_['text_tuning']               = 'Настройка загрузки';
$_['text_result']               = 'Результат загрузки';
$_['text_delivery']             = 'Тип доставки';
$_['text_upload_xls']           = 'Отправить отмеченное в заказ';
$_['text_success_end']          = 'Обработка завершена';
