<footer>
  <div class="container">
    <div class="d-flex justify-content-between align-items-center">
      <p class="m-0"><?php echo $powered; ?></p>
      <div>
...
<div style="display: none; position: fixed">
    <form method="post" enctype="multipart/form-data" class="form form--mf-popup">
      ...
      <div class="form__group">
        <input type="text" class="input" name="data" placeholder="<?php echo date('Y-m-d');?>">
      </div>
      <div class="form__group">
        <input type="text" class="input" name="name" placeholder="Имя">
      </div>
      <div class="form__group">
        <input type="text" class="input input--phone" name="phone" placeholder="Ваш e-mail или телефон">
      </div>
      <div class="form__group">
        <textarea name="comment" rows="5" class="textarea" placeholder="Ваше сообщение"></textarea>
      </div>
      <div class="form__group">
        <button class="btn btn--black" id="msg_send1"
...
$('#msg_send').on('click', function() {
  ...
  $.ajax({
    ...
    type: 'post',
    data: $('#dj_form input, #dj_form textarea'),
    dataType: 'json',
    beforeSend: function() {
    ...
    //debugger;
      ...
      if (json['error']) {
       ...
       show_modal_msg('<div class="alert-error">' + json['error'] + '</div>');
      }
      ...
      if (json['success']) {
        ...
        $('#dj_form input').val('');
        $('#dj_form textarea').text('');
        $('#dj_form textarea').html('');
        $('#dj_form textarea').val('');
...
<div class="modal_msg animated bounceIn"></div>
