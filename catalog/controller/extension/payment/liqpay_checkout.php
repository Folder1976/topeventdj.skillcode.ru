...
class ControllerExtensionPaymentLiqPayCheckout extends Controller
{
    ...
    public function callback()
    {
		...
		$current .= $order_id." ftp://folkmoda/www/petro.bitte20.in.ua/catalog/controller/extension/payment/liqpay_checkout.php\n";
        ...
        if ($signature == $this->request->post['signature']) {
            ...
            $this->model_checkout_order->addOrderHistory($order_id, 17);
